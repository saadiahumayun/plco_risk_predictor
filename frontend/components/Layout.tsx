...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/history', label: 'Patient History', icon: Icons.history },
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center space-x-3 flex-shrink-0">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500 leading-tight">AI-Powered Risk Assessment</p>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <div className="hidden sm:block text-right">
                <p className="text-sm font-medium text-gray-700">Dr. M. Moosajee</p>
                <p className="text-xs text-gray-500">Oncologist</p>
              </div>
              <div className="w-9 h-9 bg-gradient-to-br from-primary to-primary-dark rounded-full flex items-center justify-center text-white text-sm font-medium">
                MM
              </div>
            </div>
          </div>
